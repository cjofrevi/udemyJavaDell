...
public abstract class Good implements Product{
    ...
    public Good(String name, int modelNumber, double height, UnitOfMeasureType unitOfMeasure,
                boolean flammable, double weightPerUofM) {
        this.name = name;
